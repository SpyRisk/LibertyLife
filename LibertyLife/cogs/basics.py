...
class General:
    ...
    async def info(self, ctx):
        ...
        em = discord.Embed(title='Informations sur Evz-Dj', description=text.format(os_info, platform.python_version(), socket.gethostname(), discord.__version__), colour=0x89C4F9)
    ...
    async def help(self, ctx):
        ...
        em = discord.Embed(title='Commandes de Eve-Dj', description=text, colour=0x89C4F9)
        await ctx.send(embed=em)
